...
const serviceSpecificCredential_1 = require("./serviceSpecificCredential");
const signingCertificate_1 = require("./signingCertificate");
    ...
    construct: (name, type, urn) => {
        switch (type) {
            ...
            case "aws:iam/serviceSpecificCredential:ServiceSpecificCredential":
                return new serviceSpecificCredential_1.ServiceSpecificCredential(name, undefined, { urn });
            case "aws:iam/signingCertificate:SigningCertificate":
                return new signingCertificate_1.SigningCertificate(name, undefined, { urn });
