...
const (
	AtomType_INT    AtomType = 0
	AtomType_STRING AtomType = 1
	AtomType_BOOL   AtomType = 2
	AtomType_DOUBLE AtomType = 3
)
...
type Ast struct {
	...
	//	*Ast_Binary
	TreeType isAst_TreeType `protobuf_oneof:"tree_type"`
}
...
func (m *Ast) GetTreeType() isAst_TreeType {
	if m != nil {
		return m.TreeType
	}
	return nil
...
func (x *Ast) GetBinary() *Binary {
	if x, ok := x.GetTreeType().(*Ast_Binary); ok {
		return x.Binary
	}
	return nil
}

type isAst_TreeType interface {
	isAst_TreeType()
}

type Ast_Binary struct {
	Binary *Binary `protobuf:"bytes,1,opt,name=binary,proto3,oneof"`
}

func (*Ast_Binary) isAst_TreeType() {}
...
type Atom struct {
	...
	AtomType AtomType `protobuf:"varint,1,opt,name=atom_type,json=atomType,proto3,enum=AtomType" json:"atom_type,omitempty"`
...
func (x *Atom) GetAtomType() AtomType {
	if x != nil {
		return x.AtomType
	}
	return AtomType_INT
...
type List struct {
	...
	Elems []*Ast `protobuf:"bytes,1,rep,name=elems,proto3" json:"elems,omitempty"`
}
...
var file_ast_proto_rawDesc = []byte{
	,
	...
	,
...
var file_ast_proto_goTypes = []interface{}{
	...
	(*Var)(nil),       // 9: Var
	(*Table)(nil),     // 10: Table
	nil,               // 11: Dict.ValuesEntry
}
var file_ast_proto_depIdxs = []int32{
	2,  // 0: Ast.binary:type_name -> Binary
	1,  // 1: Binary.left:type_name -> Ast
	1,  // 2: Binary.right:type_name -> Ast
	1,  // 3: Statement.body:type_name -> Ast
	3,  // 4: Query.statements:type_name -> Statement
	0,  // 5: Atom.atom_type:type_name -> AtomType
	1,  // 6: List.elems:type_name -> Ast
	11, // 7: Dict.values:type_name -> Dict.ValuesEntry
	1,  // 8: OpCall.operand:type_name -> Ast
	7,  // 9: OpCall.kwargs:type_name -> Dict
	1,  // 10: Table.inner:type_name -> Ast
	1,  // 11: Dict.ValuesEntry.value:type_name -> Ast
