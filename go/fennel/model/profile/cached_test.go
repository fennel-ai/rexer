...
func (m *mockProvider) set(this instance.Instance, otype uint32, oid uint64, key string, version uint64, valueSer []byte) error {
	return nil
}
func (m *mockProvider) get(this instance.Instance, otype uint32, oid uint64, key string, version uint64) ([]byte, error) {
	return m.ret, nil
}
...
func TestCaching(t *testing.T) {
	...
	err = p.set(this, 1, 1232, "summary", 1, []byte{7, 8, 9})
	assert.NoError(t, err)
