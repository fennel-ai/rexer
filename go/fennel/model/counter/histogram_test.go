...
func TestStart(t *testing.T) {
	...
	testHistogramStart(t, Histogram{MergeReduce: NewAverage(aggregate.Options{Durations: durations})}, durations, badDurations)
	testHistogramStart(t, Histogram{MergeReduce: NewList(aggregate.Options{Durations: durations})}, durations, badDurations)
	testHistogramStart(t, Histogram{MergeReduce: NewMax(aggregate.Options{Durations: durations})}, durations, badDurations)
	testHistogramStart(t, Histogram{MergeReduce: NewMin(aggregate.Options{Durations: durations})}, durations, badDurations)
	testHistogramStart(t, Histogram{MergeReduce: NewRate(1, aggregate.Options{Durations: durations})}, durations, badDurations)
	testHistogramStart(t, Histogram{MergeReduce: NewStdDev(aggregate.Options{Durations: durations})}, durations, badDurations)
	testHistogramStart(t, Histogram{MergeReduce: NewSum(aggregate.Options{Durations: durations})}, durations, badDurations)
	testHistogramStart(t, Histogram{MergeReduce: NewTopK(aggregate.Options{Durations: durations})}, durations, badDurations)
}
...
func testHistogramStart(t *testing.T, h Histogram, durations []uint32, badDurations []uint32) {
	for _, d := range durations {
		...
		s, err := Start(h, ftypes.Timestamp(d+10), kwargs)
