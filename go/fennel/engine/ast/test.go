...
func init() {
	...
	TestExamples = []Ast{
		...
		FnCall{
			...
			Name:   "something",
			Kwargs: map[string]Ast{
				"hi":        List{Values: []Ast{List{Values: []Ast{MakeInt(1), MakeDouble(3.4)}}, List{Values: []Ast{MakeInt(2), MakeDouble(4.4)}}}},
				"something": List{Values: []Ast{MakeInt(2), MakeDouble(4.4)}},
			},
		},
		FnCall{
			Module: "std",
