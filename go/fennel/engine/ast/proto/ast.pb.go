...
type HighFnType int32

const (
	HighFnType_none    HighFnType = 0
	HighFnType_map     HighFnType = 1
	HighFnType_filter  HighFnType = 2
	HighFnType_orderby HighFnType = 3
	HighFnType_groupby HighFnType = 4
	HighFnType_reduce  HighFnType = 5
)

// Enum value maps for HighFnType.
var (
	HighFnType_name = map[int32]string{
		0: "none",
		1: "map",
		2: "filter",
		3: "orderby",
	...
	HighFnType_value = map[string]int32{
		"none":    0,
		"map":     1,
		"filter":  2,
		"orderby": 3,
...
func (x HighFnType) Enum() *HighFnType {
	p := new(HighFnType)
	*p = x
	return p
}

func (x HighFnType) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (HighFnType) Descriptor() protoreflect.EnumDescriptor {
	return file_ast_proto_enumTypes[0].Descriptor()
}

func (HighFnType) Type() protoreflect.EnumType {
	return &file_ast_proto_enumTypes[0]
}

func (x HighFnType) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use HighFnType.Descriptor instead.
func (HighFnType) EnumDescriptor() ([]byte, []int) {
...
func (x *Ast) GetFncall() *FnCall {
	if x, ok := x.GetNode().(*Ast_Fncall); ok {
		return x.Fncall
	}
	return nil
}

func (x *Ast) GetHfncall() *HighFnCall {
	if x, ok := x.GetNode().(*Ast_Hfncall); ok {
		return x.Hfncall
	}
	return nil
}
...
type Ast_At struct {
	...
	At *At `protobuf:"bytes,10,opt,name=at,proto3,oneof"`
}
...
type Ast_Fncall struct {
	Fncall *FnCall `protobuf:"bytes,13,opt,name=fncall,proto3,oneof"`
}

type Ast_Hfncall struct {
	Hfncall *HighFnCall `protobuf:"bytes,14,opt,name=hfncall,proto3,oneof"`
}
...
func (*Ast_At) isAst_Node() {}

func (*Ast_Lookup) isAst_Node() {}

func (*Ast_Ifelse) isAst_Node() {}

func (*Ast_Fncall) isAst_Node() {}

func (*Ast_Hfncall) isAst_Node() {}
...
type HighFnCall struct {
	...
	Type    HighFnType `protobuf:"varint,1,opt,name=Type,proto3,enum=HighFnType" json:"Type,omitempty"`
	Varname string     `protobuf:"bytes,2,opt,name=varname,proto3" json:"varname,omitempty"`
	Lambda  *Ast       `protobuf:"bytes,3,opt,name=Lambda,proto3" json:"Lambda,omitempty"`
	Iter    *Ast       `protobuf:"bytes,4,opt,name=iter,proto3" json:"iter,omitempty"`
}

func (x *HighFnCall) Reset() {
	*x = HighFnCall{}
	if protoimpl.UnsafeEnabled {
...
func (x *HighFnCall) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*HighFnCall) ProtoMessage() {}

func (x *HighFnCall) ProtoReflect() protoreflect.Message {
	mi := &file_ast_proto_msgTypes[13]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use HighFnCall.ProtoReflect.Descriptor instead.
func (*HighFnCall) Descriptor() ([]byte, []int) {
	return file_ast_proto_rawDescGZIP(), []int{13}
}

func (x *HighFnCall) GetType() HighFnType {
	if x != nil {
		return x.Type
	}
	return HighFnType_none
}

func (x *HighFnCall) GetVarname() string {
	if x != nil {
		return x.Varname
	}
	return ""
...
func (x *HighFnCall) GetLambda() *Ast {
	if x != nil {
		return x.Lambda
	}
	return nil
...
var file_ast_proto_rawDesc = []byte{
	0x0a, 0x09, 0x61, 0x73, 0x74, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xb9, 0x03, 0x0a, 0x03,
	...
	,
	...
	,
	...
	,
	...
	,
...
var file_ast_proto_msgTypes = make([]protoimpl.MessageInfo, 16)
var file_ast_proto_goTypes = []interface{}{
	(HighFnType)(0),    // 0: HighFnType
	(*Ast)(nil),        // 1: Ast
	(*Binary)(nil),     // 2: Binary
	...
	(*Var)(nil),        // 9: Var
	(*At)(nil),         // 10: At
	(*Lookup)(nil),     // 11: Lookup
	(*IfElse)(nil),     // 12: IfElse
	(*FnCall)(nil),     // 13: FnCall
	(*HighFnCall)(nil), // 14: HighFnCall
	nil,                // 15: Dict.ValuesEntry
	nil,                // 16: FnCall.KwargsEntry
}
var file_ast_proto_depIdxs = []int32{
	...
	10, // 8: Ast.at:type_name -> At
	11, // 9: Ast.lookup:type_name -> Lookup
	12, // 10: Ast.ifelse:type_name -> IfElse
	13, // 11: Ast.fncall:type_name -> FnCall
	14, // 12: Ast.hfncall:type_name -> HighFnCall
	1,  // 13: Binary.left:type_name -> Ast
	1,  // 14: Binary.right:type_name -> Ast
	1,  // 15: Statement.body:type_name -> Ast
	3,  // 16: Query.statements:type_name -> Statement
	1,  // 17: List.values:type_name -> Ast
	15, // 18: Dict.values:type_name -> Dict.ValuesEntry
	1,  // 19: OpCall.operand:type_name -> Ast
	7,  // 20: OpCall.kwargs:type_name -> Dict
	1,  // 21: Lookup.on:type_name -> Ast
	1,  // 22: IfElse.condition:type_name -> Ast
	1,  // 23: IfElse.then_do:type_name -> Ast
	1,  // 24: IfElse.else_do:type_name -> Ast
	16, // 25: FnCall.kwargs:type_name -> FnCall.KwargsEntry
	0,  // 26: HighFnCall.Type:type_name -> HighFnType
	1,  // 27: HighFnCall.Lambda:type_name -> Ast
	1,  // 28: HighFnCall.iter:type_name -> Ast
	1,  // 29: Dict.ValuesEntry.value:type_name -> Ast
	1,  // 30: FnCall.KwargsEntry.value:type_name -> Ast
