...
var file_ast_proto_rawDesc = []byte{
	0x0a, 0x09, 0x61, 0x73, 0x74, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x99, 0x03, 0x0a, 0x03,
	...
	0x2e, 0x55, 0x6e, 0x61, 0x72, 0x79, 0x48, 0x00, 0x52, 0x05, 0x75, 0x6e, 0x61, 0x72, 0x79, 0x42,
	...
	0x02, 0x38, 0x01, 0x42, 0x19, 0x5a, 0x17, 0x66, 0x65, 0x6e, 0x6e, 0x65, 0x6c, 0x2f, 0x65, 0x6e,
	0x67, 0x69, 0x6e, 0x65, 0x2f, 0x61, 0x73, 0x74, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x06,
...
var file_ast_proto_depIdxs = []int32{
	...
	0,  // 12: Unary.operand:type_name -> Ast
	0,  // 13: Binary.left:type_name -> Ast
	0,  // 14: Binary.right:type_name -> Ast
	0,  // 15: Statement.body:type_name -> Ast
	3,  // 16: Query.statements:type_name -> Statement
	0,  // 17: List.values:type_name -> Ast
	13, // 18: Dict.values:type_name -> Dict.ValuesEntry
	7,  // 19: OpCall.kwargs:type_name -> Dict
	0,  // 20: OpCall.operands:type_name -> Ast
	...
	14, // 25: FnCall.kwargs:type_name -> FnCall.KwargsEntry
	0,  // 26: Dict.ValuesEntry.value:type_name -> Ast
	0,  // 27: FnCall.KwargsEntry.value:type_name -> Ast
