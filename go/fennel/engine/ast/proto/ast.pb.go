...
type Ast_Fncall struct {
	Fncall *FnCall `protobuf:"bytes,13,opt,name=fncall,proto3,oneof"` // HighFnCall hfncall = 14; [deprecated now]
}
...
var file_ast_proto_rawDesc = []byte{
	0x0a, 0x09, 0x61, 0x73, 0x74, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xf9, 0x02, 0x0a, 0x03,
	...
	0x6e, 0x43, 0x61, 0x6c, 0x6c, 0x48, 0x00, 0x52, 0x06, 0x66, 0x6e, 0x63, 0x61, 0x6c, 0x6c, 0x42,
...
var file_ast_proto_msgTypes = make([]protoimpl.MessageInfo, 14)
var file_ast_proto_goTypes = []interface{}{
	...
	(*Var)(nil),       // 8: Var
	(*Lookup)(nil),    // 9: Lookup
	(*IfElse)(nil),    // 10: IfElse
	(*FnCall)(nil),    // 11: FnCall
	nil,               // 12: Dict.ValuesEntry
	nil,               // 13: FnCall.KwargsEntry
}
var file_ast_proto_depIdxs = []int32{
	...
	9,  // 8: Ast.lookup:type_name -> Lookup
	10, // 9: Ast.ifelse:type_name -> IfElse
	11, // 10: Ast.fncall:type_name -> FnCall
	0,  // 11: Binary.left:type_name -> Ast
	0,  // 12: Binary.right:type_name -> Ast
	0,  // 13: Statement.body:type_name -> Ast
	2,  // 14: Query.statements:type_name -> Statement
	0,  // 15: List.values:type_name -> Ast
	12, // 16: Dict.values:type_name -> Dict.ValuesEntry
	6,  // 17: OpCall.kwargs:type_name -> Dict
	0,  // 18: OpCall.operands:type_name -> Ast
	0,  // 19: Lookup.on:type_name -> Ast
	0,  // 20: IfElse.condition:type_name -> Ast
	0,  // 21: IfElse.then_do:type_name -> Ast
	0,  // 22: IfElse.else_do:type_name -> Ast
	13, // 23: FnCall.kwargs:type_name -> FnCall.KwargsEntry
	0,  // 24: Dict.ValuesEntry.value:type_name -> Ast
	0,  // 25: FnCall.KwargsEntry.value:type_name -> Ast
