...
func (x *ProtoAggregate) GetTimestamp() uint32 {
	if x != nil {
		return x.Timestamp
	}
	return 0
...
func (x *AggOptions) GetDurations() []uint32 {
	if x != nil {
		return x.Durations
	}
	return nil
...
func (x *AggOptions) GetLimit() uint32 {
	if x != nil {
		return x.Limit
	}
	return 0
...
var file_aggregate_proto_rawDesc = []byte{
	...
	0x03, 0x28, 0x0d, 0x52, 0x09, 0x64, 0x75, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x12, 0x1f,
