...
type ProtoRow struct {
	...
	ContextOid      uint64        `protobuf:"varint,2,opt,name=ContextOid,proto3" json:"ContextOid,omitempty"`
	CandidateOType  string        `protobuf:"bytes,3,opt,name=CandidateOType,proto3" json:"CandidateOType,omitempty"`
	CandidateOid    uint64        `protobuf:"varint,4,opt,name=CandidateOid,proto3" json:"CandidateOid,omitempty"`
	...
	RequestID       uint64        `protobuf:"varint,7,opt,name=RequestID,proto3" json:"RequestID,omitempty"`
	Timestamp       uint64        `protobuf:"varint,8,opt,name=Timestamp,proto3" json:"Timestamp,omitempty"`
	ModelID         string        `protobuf:"bytes,9,opt,name=ModelID,proto3" json:"ModelID,omitempty"`
	ModelPrediction float64       `protobuf:"fixed64,10,opt,name=ModelPrediction,proto3" json:"ModelPrediction,omitempty"`
}
...
func (x *ProtoRow) GetContextOid() uint64 {
	if x != nil {
		return x.ContextOid
	}
	return 0
...
func (x *ProtoRow) GetCandidateOid() uint64 {
	if x != nil {
...
func (x *ProtoRow) GetRequestID() uint64 {
	if x != nil {
		return x.RequestID
	}
	return 0
...
func (x *ProtoRow) GetModelID() string {
	if x != nil {
		return x.ModelID
	}
	return ""
...
var file_feature_proto_rawDesc = []byte{
	...
	0x0b, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xdb, 0x02, 0x0a,
	...
	0x04, 0x52, 0x0a, 0x43, 0x6f, 0x6e, 0x74, 0x65, 0x78, 0x74, 0x4f, 0x69, 0x64, 0x12, 0x26, 0x0a,
	...
	0x74, 0x65, 0x4f, 0x69, 0x64, 0x18, 0x04, 0x20, 0x01, 0x28, 0x04, 0x52, 0x0c, 0x43, 0x61, 0x6e,
	...
	0x71, 0x75, 0x65, 0x73, 0x74, 0x49, 0x44, 0x18, 0x07, 0x20, 0x01, 0x28, 0x04, 0x52, 0x09, 0x52,
	...
	0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x12, 0x18, 0x0a, 0x07, 0x4d, 0x6f, 0x64, 0x65, 0x6c, 0x49,
	0x44, 0x18, 0x09, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x4d, 0x6f, 0x64, 0x65, 0x6c, 0x49, 0x44,
	0x12, 0x28, 0x0a, 0x0f, 0x4d, 0x6f, 0x64, 0x65, 0x6c, 0x50, 0x72, 0x65, 0x64, 0x69, 0x63, 0x74,
	0x69, 0x6f, 0x6e, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x01, 0x52, 0x0f, 0x4d, 0x6f, 0x64, 0x65, 0x6c,
	0x50, 0x72, 0x65, 0x64, 0x69, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x42, 0x14, 0x5a, 0x12, 0x66, 0x65,
	0x6e, 0x6e, 0x65, 0x6c, 0x2f, 0x6c, 0x69, 0x62, 0x2f, 0x66, 0x65, 0x61, 0x74, 0x75, 0x72, 0x65,
