...
func (s S3) Validate() error {
	...
	if len(s.Name) > 255 {
		return fmt.Errorf("source name cannot be longer than 255 characters")
	}
	if len(s.Bucket) > 255 {
		return fmt.Errorf("bucket cannot be longer than 255 characters")
	}
	if len(s.PathPrefix) > 255 {
		return fmt.Errorf("path_prefix cannot be longer than 255 characters")
	}
	if len(s.Schema) > 1024 {
		return fmt.Errorf("schema cannot be longer than 1024 characters")
	}
	return nil
}
...
func (s BigQuery) Validate() error {
	...
	if len(s.ProjectId) > 255 {
		return fmt.Errorf("project_id cannot be longer than 255 characters")
	}
	if len(s.DatasetId) > 255 {
		return fmt.Errorf("dataset_id cannot be longer than 255 characters")
	}
	return nil
}
...
func (s Postgres) Validate() error {
	...
	if len(s.Host) > 255 {
		return fmt.Errorf("host cannot be longer than 255 characters")
	}
	if len(s.Dbname) > 255 {
		return fmt.Errorf("dbname cannot be longer than 255 characters")
	}
	return nil
}
