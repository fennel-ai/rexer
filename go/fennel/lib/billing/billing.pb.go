...
type BillingCountersProto struct {
...
func (x *BillingCountersProto) Reset() {
	*x = BillingCountersProto{}
...
func (x *BillingCountersProto) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BillingCountersProto) ProtoMessage() {}

func (x *BillingCountersProto) ProtoReflect() protoreflect.Message {
	mi := &file_billing_proto_msgTypes[0]
...
// Deprecated: Use BillingCountersProto.ProtoReflect.Descriptor instead.
func (*BillingCountersProto) Descriptor() ([]byte, []int) {
	return file_billing_proto_rawDescGZIP(), []int{0}
}

func (x *BillingCountersProto) GetQueries() uint64 {
	if x != nil {
		return x.Queries
	}
	return 0
...
func (x *BillingCountersProto) GetActions() uint64 {
	if x != nil {
		return x.Actions
	}
	return 0
...
func (x *BillingCountersProto) GetTimestamp() uint64 {
	if x != nil {
		return x.Timestamp
	}
	return 0
...
var file_billing_proto_rawDesc = []byte{
	,
...
var file_billing_proto_goTypes = []interface{}{
	(*BillingCountersProto)(nil), // 0: BillingCountersProto
}
...
func file_billing_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_billing_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*BillingCountersProto); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
