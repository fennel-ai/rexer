...
func TestToTable(t *testing.T) {
	a1 := Action{ActionID: 1, CustID: 2, ActorID: 3, ActorType: "user", TargetID: 5, TargetType: "photo", ActionType: "like", ActionValue: 8, Timestamp: 9, RequestID: 10}
	a2 := Action{ActionID: 11, CustID: 12, ActorID: 13, ActorType: "other", TargetID: 15, TargetType: "video", ActionType: "myaction", ActionValue: 18, Timestamp: 19, RequestID: 20}
	a3 := Action{ActionID: 21, CustID: 22, ActorID: 23, ActorType: "admin", TargetID: 25, TargetType: "arbitrary", ActionType: "share", ActionValue: 28, Timestamp: 29, RequestID: 30}
