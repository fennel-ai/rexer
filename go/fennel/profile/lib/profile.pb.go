...
type ProtoProfileItem struct {
	...
	OType   int32         `protobuf:"varint,1,opt,name=OType,proto3" json:"OType,omitempty"`
...
func (x *ProtoProfileItem) GetOType() int32 {
	if x != nil {
		return x.OType
	}
	return 0
...
var file_profile_proto_rawDesc = []byte{
	...
	0x6d, 0x12, 0x14, 0x0a, 0x05, 0x4f, 0x54, 0x79, 0x70, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x05,
	...
	0x61, 0x6c, 0x75, 0x65, 0x42, 0x11, 0x5a, 0x0f, 0x66, 0x65, 0x6e, 0x6e, 0x65, 0x6c, 0x2f, 0x64,
	0x61, 0x74, 0x61, 0x2f, 0x6c, 0x69, 0x62, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
