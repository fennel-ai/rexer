...
func TestFeatureLog_Apply(t *testing.T) {
	...
	kwargs := []value.Dict{
		value.NewDict(map[string]value.Value{"context_otype": value.String("user"), "context_oid": value.String("1"), "candidate_otype": value.String("video"), "candidate_oid": value.String("723"), "request_id": value.Int(1232), "features": f1, "model_prediction": value.Double(0.59), "timestamp": value.Int(0)}),
		value.NewDict(map[string]value.Value{"context_otype": value.String("user"), "context_oid": value.String("2"), "candidate_otype": value.String("video"), "candidate_oid": value.String("823"), "request_id": value.Int(1233), "features": f2, "model_prediction": value.Double(0.79), "timestamp": value.Int(12312)}),
	}
