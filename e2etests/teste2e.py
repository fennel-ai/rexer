...
class TestEndToEnd(unittest.TestCase):
    ...
    def test_e2e_tuple(self):
        ...
        expected4 = [expected2, expected3[0]]
        ...
        while slept < 120:
            ...
            if found1 == expected1 and found2 == expected2 and compare_lists(found3, expected3) and found4[0] == \
                    expected4[0] and compare_lists(found4[1], expected4[1]):
                passed = True
                break
            time.sleep(5)
            slept += 5
